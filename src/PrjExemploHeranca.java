...
public class PrjExemploHeranca {
    ...
    public static void main(String[] args) {
        ...
        md3.mostrarPessoa(pj);
        md3.mostrarCarro(lstCarroPj);
        md3.mostrarCarro(c3);*/
        
        ManterArquivo ma = new ManterArquivo();
        MostrarDados3 d3 = new MostrarDados3();
        
        //ma.escreverArquivo(pf);
        
        List<Pessoa> lstP = ma.lerArquivo();
        for(Pessoa pessoa : lstP){
            d3.mostrarPessoa(pessoa);
            System.out.println("***********************************");
        }
